...
import com.eclectics.io.mavenpipeline.utils.responses.EntityResponse;
...
public class DepartmentService {
    ...
    public EntityResponse create(Department department) {
        try {
            ...
            Optional<Department> checkName = departmentRepository.findByDepartmentName(department.getDepartmentName());
            if (checkName.isPresent()) {
                response.setMessage("Department " + department.getDepartmentName() + " Already Taken !!");
                ...
                response.setMessage(" Department " + addNew.getDepartmentName() + " Created Successfully at " + addNew.getPostedTime());
